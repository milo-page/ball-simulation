...
def main():
    ...
    while running:
        ...
        for i in range(1,ballmax - 1):
            pygame.gfxdraw.filled_circle(screen, round(balllist[i].x), round(balllist[i].y), balllist[i].radius, (balllist[i].colour[0], balllist[i].colour[1], balllist[i].colour[2], round(100*balllist[i].KE/15000)))
